...
export class PostsController {
  ...
  @ApiOperation({ summary: '게시글 작성', description: '새로운 게시글을 작성합니다. (로그인 필요)' })
  ...
  @ApiParam({ name: 'id', description: '게시글 ID (MongoDB ObjectId)', example: '507f1f77bcf86cd799439011' })
  ...
  @ApiParam({ name: 'id', description: '게시글 ID', example: '507f1f77bcf86cd799439011' })
